...
EOH;
		...
		function getFotter()
		{
			$footer = '<br /><br /><br /><table>';
				$footer .='<tr>';
             		$footer .='<td>';	
              			$footer .='<h4 style="display: inline-block; font-size: 20px; font-weight: 400; margin: 0px;">Malestrom Lawyers</h4>';
              		$footer .='</td>';	
            	$footer .='</tr>';
           		$footer .='<tr>';
             		$footer .='<td>';
						$footer .='<p>Level 13, 50 Cavill Avenue <br /> SURFERS PARADISE 4215</p>';
					$footer .='</td>';	
            	$footer .='</tr>';
			$footer .= '</table >'; 
			$footer .= '</body></html>';
